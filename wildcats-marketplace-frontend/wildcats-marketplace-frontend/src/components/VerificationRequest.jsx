  ...
  return (
    <div className="w-full h-full flex flex-col gap-4 p-2">
      ...
      <div className="flex justify-between flex-wrap">
        <div className="flex justify-between items-center font-semibold p-3 py-6 w-50 rounded-md shadow-md border-2 border-[#A31800] bg-gradient-to-r from-red-700 to-amber-800 text-white">
        ...
        <div className="flex justify-between items-center font-semibold p-3 py-6 w-50 rounded-md shadow-md border-2 border-[#A31800] bg-gradient-to-r from-orange-600 to-amber-700 text-white">
          <div className="flex flex-col">
            <h6>Pending</h6>
            <h4 className="text-3xl font-bold">0</h4>
          </div>
        ...
        <div className="flex justify-between items-center font-semibold p-3 py-6 w-50 rounded-md shadow-md border-2 border-[#A31800] bg-gradient-to-r from-green-600 to-green-800 text-white">
          <div className="flex flex-col">
            <h6>Approved</h6>
            <h4 className="text-3xl font-bold">0</h4>
          </div>
        ...
        <div className="flex justify-between items-center font-semibold p-3 py-6 w-50 rounded-md shadow-md border-2 border-[#A31800] bg-gradient-to-r from-red-600 to-red-800 text-white">
          <div className="flex flex-col">
            <h6>Rejected</h6>
            <h4 className="text-3xl font-bold">0</h4>
          </div>
      ...
      <div className="p-3 px-6 flex flex-col bg-[#FFF7DA] rounded-md shadow-md border-2 border-[#A31800]">
        <div className="flex items-center py-3 gap-2">
          ...
          <h4 className="text-red-900 font-bold">Filter Requests</h4>
        </div>
      ...
      <div>
        ...
        {filteredRequests.length > 0 ? (
          ...
          <div className="w-full bg-[#FFF7DA] flex rounded-md shadow-md border-2 border-[#A31800]">
            <div className="w-full h-full flex flex-col justify-center items-center py-12 box-border">
              <AlertCircle className="w-15 h-15 text-red-900 mb-3" />
