              ...
              {(localProduct.comments || []).map((comment) => (
                <div key={comment.id} className='flex flex-col gap-2'>
                  ...
                  <div className='flex items-start gap-1.5'>
                    <img className='w-10 h-10 rounded-full p-2 bg-gray-100 border-1 border-gray-200' src={comment.profile}></img>
                    ...
                    <div className='ml-12 flex flex-col gap-2'>
                      {comment.replies.map((reply) => (
                        <div key={reply.id} className='flex items-start gap-1.5'>
                          <img className='w-8 h-8 rounded-full p-1.5 bg-gray-100 border-1 border-gray-200' src={reply.profile}></img>
                          <div className='flex flex-col w-full'>
                  ...
                  {replyingTo === comment.id && (
                    <div className='ml-12 flex items-center gap-2'>
                      <img className='w-8 h-8 rounded-full p-1.5 bg-gray-100 border-1 border-gray-200' src={assets.blank_profile_icon}></img>
